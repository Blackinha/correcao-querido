...
export default function CadastroJogadores() {
  ...
  // Carregar equipes do localStorage ou definir equipes iniciais
  useEffect(() => {
  ...
  const handleSubmit = (e) => {
    ...
    jogador.id = Date.now(); // Gera um ID único para o jogador
    jogadoresLocalStorage.push(jogador);
    localStorage.setItem("Jogadores", JSON.stringify(jogadoresLocalStorage));
    alert("Jogador cadastrado com sucesso!");
    router.push("/jogadores"); // Redireciona para a lista de jogadores
  };
